(function(global, $) { var
	...
	bottom_position = '1630px', fixed_position = '190px', scroll_bottom = '1550';
	...
	function onScroll() {
		...
		} else if(topPos > 200 && topPos < scroll_bottom) {
			scrollingGraphic.css({'position':'fixed','top':fixed_position})
		} else if(topPos < 200) {
			scrollingGraphic.css({'position':'absolute','top':fixed_position})
		}
